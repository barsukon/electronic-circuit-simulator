...
class GroundElm extends CircuitElm {
    ...
    void stamp() {
        if (isOldStyle()) sim.stampVoltageSource(0, nodes[0], voltSource, 0);
    }
    ...
    Point getConnectedPost() {
        if (firstGround != null) return firstGround;
        firstGround = point1;
        return null;
    }
    ...
    public void setEditValue(int n, EditInfo ei) {
        if (n == 0) lastSymbolType = symbolType = ei.choice.getSelectedIndex();
    }
