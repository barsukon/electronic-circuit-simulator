...
class Inductor {
    ...
    void stamp(int n0, int n1) {
        ...
        nodes[0] = n0;
        nodes[1] = n1;
        if (isTrapezoidal()) compResistance = (2 * inductance) / sim.timeStep;
        else compResistance = inductance / sim.timeStep; // backward euler
    ...
    void startIteration(double voltdiff) {
        ...
        else curSourceValue = current; // backward euler
    }
